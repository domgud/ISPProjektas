    ...
    <div class="card-body">
        <form action="{{ route('shop.store') }}" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="gamintojas" type="text" class="form-control " name="gamintojas" value="{{ old('gamintojas') }}">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <textarea  id="aprasymas" type="text" class="form-control " name="aprasymas">{{ old('aprasymas') }}</textarea>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-2">
                    <input id="kaina" type="number" step="0.01" class="form-control " name="kaina" value="{{ old('kaina') }}">
                </div>
            </div>
            ...
            <a href="{{route('shop.index')}}"> <button type="button" class="btn btn-primary float-left" style="background-color: #1b1e21">Atgal</button> </a>
